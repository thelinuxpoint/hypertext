...
main: $(cfiles) $(hfiles) $(ofiles)
	...
	@clang++-11 -std=c++20 -Wall  $(cflags) main.cc -o ./build/hypertext  $(ofiles) $(libs) 
...
./build/hypertextapp.o: ./src/component/hypertextapp.cc ./src/header/hypertextapp.h
	...
	@clang++-11 -std=c++20 -c $(cflags) ./src/component/hypertextapp.cc -o ./build/hypertextapp.o 
	@echo " => [ok]"
# 
./build/hypwindow.o: ./src/component/hypwindow.cc ./src/header/hypwindow.h
	@printf "Compiling hypwindow.cc ~> hypwindow.o"
	@clang++-11 -std=c++20 -c $(cflags) ./src/component/hypwindow.cc -o ./build/hypwindow.o 
	@echo " => [ok]"
